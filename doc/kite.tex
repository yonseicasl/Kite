...
For instance, suppose that {\tt x10} {\tt =} {\tt 21} and {\tt x11} {\tt =} {\tt 15}.
In the first iteration, the remainder of {\tt x10} {\tt /} {\tt x11} (i.e., modulo operation) is stored in the {\tt x5} register, which is {\tt x5} {\tt =} {\tt 6}.
Then, {\tt x11} and {\tt x5} are copied to {\tt x10} and {\tt x11}, respectively.
The second iteration makes {\tt x5} {\tt =} {\tt 3} by taking the remainder of {\tt 15} {\tt /} {\tt 6}, and {\tt x10} {\tt =} {\tt 6} and {\tt x11} {\tt =} {\tt 3}.
In the third iteration, {\tt x5} {\tt =} {\tt 0}, {\tt x10} {\tt =} {\tt 3}, and {\tt x11} {\tt =} {\tt 0}.
The loop reaches the end for {\tt x11} {\tt ==} {\tt 0}.
