...
The correct values of source operand registers appear when the instruction moves to decode stage, and the value of destination operand register (if any) becomes available when the instruction reaches execute stage.
